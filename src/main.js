...
function swagger(app, config) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, description, version, options, document;
        return __generator(this, function (_b) {
            _a = config.getPackageInfo(), description = _a.description, version = _a.version;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    app = _a.sent();
                    return [4 /*yield*/, app.get(config_service_1.ConfigService)];
                case 2:
                    config = _a.sent();
                    return [4 /*yield*/, config.load()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, swagger(app, config)];
                case 4:
                    _a.sent();
